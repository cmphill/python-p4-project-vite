...
export default function Login({ onLogin }) {
    ...
    return (
        <div className="login-container p-10 flex flex-col items-center">
            <form className="p-6 flex flex-col text-gray-800 gap-3 bg-red-400 border-red-800 border-2 rounded-md" onSubmit={formik.handleSubmit}>
                ...
                <input className="rounded text-gray-200" type="text" id='username' name="username" value={formik.values.username} onChange={formik.handleChange} />

                <label className="pr-60 border-b-2 border-red-500 font-bold">Password</label>
                <input className="rounded text-gray-200" type="password" id='password' name="password" value={formik.values.password} onChange={formik.handleChange} />
            ...
            <div className="text-md flex gap-2 m-3">
              ...
              <NavLink className="btn2 font-bold text-red-600" to="../signup"> Create an Account </NavLink>
            </div>
        </div>
    )
}
